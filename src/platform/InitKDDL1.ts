...
import * as LocalNlPath from "../../src.assets/i18n/nl/nl.kdd1.txt";
import * as LocalDePath from "../../src.assets/i18n/de/de.kdd1.txt";
import * as LocalFiPath from "../../src.assets/i18n/fi/fi.kdd1.txt";
import * as LocalEsPath from "../../src.assets/i18n/es/es.kdd1.txt";
import * as LocalPtPath from "../../src.assets/i18n/pt/pt.kdd1.txt";
import * as LocalFrPath from "../../src.assets/i18n/fr/fr.kdd1.txt";
import * as LocalRuPath from "../../src.assets/i18n/ru/ru.kdd1.txt";
import * as LocalPlPath from "../../src.assets/i18n/pl/pl.kdd1.txt";
